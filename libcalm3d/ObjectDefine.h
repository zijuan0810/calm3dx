#ifndef _OBJECTDEFINE_H_
#define _OBJECTDEFINE_H_
...
typedef struct SB6M_VERTEX_ATTRIB_CHUNK_t
{
	...
	SBM_VERTEX_ATTRIB_DECL     attrib_data[1];
} SBM_VERTEX_ATTRIB_CHUNK;
